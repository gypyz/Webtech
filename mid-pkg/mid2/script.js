...
form.addEventListener("submit", function (event) {
  ...
  let HomeTeam = document.querySelector("#homeTeam").value;
  let AwayTeam = document.querySelector("#awayTeam").value;
  ...
  addmatchResults(newMatch);
  //reset Data input field
...
matchResults.forEach(addmatchResults);

function addmatchResults(item) {
